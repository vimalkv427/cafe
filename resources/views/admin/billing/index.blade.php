...
<body class="pos-page">
                                                    ...
                                                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-4 col-xxl-3 product-item" data-category="{{ $product->category_id }}">
                                                        <div class="product-info card mb-0">
                                                            ...
                                                            <div class="d-flex align-items-center justify-content-between price">
                                                                <p class="text-gray-9 mb-0">£{{ $product->product_selling_cost }}</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                                ...
                                <table class="table-borderless w-100 table-fit">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end text-danger" id="receipt-discount">-£0.00</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end fw-bold" id="receipt-total">£0.00</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold">Received:</td>
                                            <td class="text-end fw-bold" id="receipt-received">£0.00</td>
                                        </tr>
                                        <tr>
                                            <td class="fw-bold"> Balance:</td>
                                            <td class="text-end fw-bold" id="receipt-balance">£0.00</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                    ...
                    <div class="text-center invoice-bar">
                        ...
                        <a href="javascript:void(0);">
                            <img src="{{ asset('assets2/images/barcode-03.jpg') }}" alt="Barcode">
                        </a>
    ...
    <script>
        ...
        <tr data-id="${item.product.id}">
            ...
            <td class="fs-13 fw-semibold text-gray-9 text-end price">£${itemTotal.toFixed(2)}</td>
        </tr>
        `;
            ...
            $(".fw-bold.text-end").text(`£${totalPayable.toFixed(2)}`);
            ...
            $(".select-product").on("click", function() {
                ...
                <tr data-id="${productId}">
                    ...
                    <td class="fs-13 fw-semibold text-gray-9 text-end price">£${productPrice.toFixed(2)}</td>
                </tr>
            `;
                    $("#cart-items").append(newRow);
                }
            ...
            function calculateTotal() {
                ...
                $(".fw-bold.text-end").text(`£${subtotal.toFixed(2)}`);
            }
        });
    </script>
    <script>
        $(document).ready(function() {
            ...
            function calculateTotal() {
                ...
                $("#cart-items tr").each(function() {
                    let price = parseFloat($(this).find(".price").text().replace("£", "")) || 0;
                    subtotal += price;
                });
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".payment-item").on("click", function() {
                let totalPayable = parseFloat($("#total-payable").text().replace("£", "")) || 0;
    ...
    $(document).ready(function() {
        $("#submitBtn, #printBtnBeforePayment").on("click", function() {
            // Determine if printing before payment
            let beforePayment = $(this).attr("id") === "printBtnBeforePayment";
            ...
            // Toggle visibility of "Received" and "Balance" fields based on print type
            if (beforePayment) {
                $("#receipt-received-row, #receipt-balance-row").hide();
            } else {
                $("#receipt-received-row, #receipt-balance-row").show();
                $("#receipt-received").text(`£${receivedAmount.toFixed(2)}`);
                $("#receipt-balance").text(`£${balance.toFixed(2)}`);
            }
