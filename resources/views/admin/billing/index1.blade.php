...
<head>
    ...
    <title>Ghaytah Restaurant</title>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-center info">
                        ...
                        <p class="mb-0">Address: <a href="">Iceroll Building , AL Qasimi Corniche Rd , <br> RAK City Ras AL Khaimah - U.A.E</a></p>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $("#submitBtn").on("click", function() {
                ...
                let year = String(now.getFullYear()).slice(-2); // Last 2 digits
            ...
            `;
                ...
                // Populate summary details
                $("#receipt-subtotal").text(`AED${sub_total.toFixed(2)}`);
