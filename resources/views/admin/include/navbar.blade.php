        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('admin.dashboard') }}" class="header-logo">
                    ...
                    <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid rounded-normal" alt="logo">
                    <h5 class="logo-title ml-3">POS Shop Dash</h5>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li>
                            <a href="{{ route('billing') }}" class="btn border add-btn shadow-none mx-2 d-none d-md-block">
                                <i class="billing mr-2"></i>Billing
                            </a>
                        </li>

                        <li>
                            <a href="{{ route('bills.order_list') }}" class="btn border add-btn shadow-none mx-2 d-none d-md-block"
                               ><i class="las la-plus mr-2"></i>Print Bills</a>
                        </li>
                                    ...
                                    <div class="card-body p-0 text-center">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-3">
                                                ...
                                                <button type="button" class="btn border" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                                    Sign Out
                                                </button>
