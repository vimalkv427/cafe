                                ...
                                <div class="card-body">
                                    ...
                                    <div class="product-added block-section">
                                        ...
                                        <div class="btn-row d-flex align-items-center justify-content-between gap-3">
                                            <button type="button" class="btn btn-white d-flex align-items-center justify-content-center flex-fill m-0" id="open-print-receipt">
                        ...
                        <div class="tax-invoice">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="invoice-user-name" id="receipt-table-number"><span>Table Number No: </span></div>
                                </div>
                                <div class="col-md-6">
        ...
        $(document).ready(function() {
            ...
            $(".select-product").on("click", function() {
                ...
                <tr data-id="${productId}">
                    ...
                    <td class="fs-13 fw-semibold text-gray-9 text-end price">${productPrice}</td>
                </tr>
            `;
...
<script>
    $(document).ready(function() {
        $("#open-print-receipt").on("click", function() {
            let tableId = $("#table-select").val();
            ...
            $("#cart-items tr").each(function() {
                ...
                let itemName = $(this).find("h6").text().trim();
                let quantity = parseInt($(this).find(".qty").val());
            ...
            $("#receipt-table-number").text("Table No: " + tableId);
        ...
        window.printReceipt = function() {
            let printContents = document.querySelector("#print-receipt .modal-body").innerHTML;
            let printWindow = window.open('', '', 'height=600,width=400');

            printWindow.document.write('<html><head><title>Print Receipt</title>');
            printWindow.document.write('<style>body{font-family:sans-serif;font-size:12px;} table{width:100%; border-collapse: collapse;} td, th{padding: 4px; border-bottom: 1px solid #ddd; text-align: left;}</style>');
