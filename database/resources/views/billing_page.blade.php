...
<head>
    ...
    <script src="{{ asset('assets1/js/theme-script.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>
    ...
    <!-- Daterangepikcer CSS -->
    <link rel="stylesheet" href="{{ asset('assets1/css/daterangepicker.css') }}">
...
<body>
            ...
            <ul class="nav user-menu">
                        ...
                        <form action="#" class="dropdown">
                            ...
                            <div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
                                ...
                                <div class="search-info">
                                    ...
                                    <ul class="customers">
                                        <li><a href="javascript:void(0);">Aron Varu<img src="images/avator1.jpg" alt="" class="img-fluid"></a></li>
                                        <li><a href="javascript:void(0);">Jonita<img src="images/avator1.jpg" alt="" class="img-fluid"></a></li>
                                        <li><a href="javascript:void(0);">Aaron<img src="images/avator1.jpg" alt="" class="img-fluid"></a></li>
                                    </ul>
                                </div>
                            </div>
                ...
                <li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link select-store" data-bs-toggle="dropdown">
                        <span class="user-info">
                            <span class="user-letter">
                                <img src="images/store-01.png" alt="Store Logo" class="img-fluid">
                            </span>
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="images/store-01.png" alt="Store Logo" class="img-fluid"> Grocery Alpha
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="images/store-02.png" alt="Store Logo" class="img-fluid"> Grocery Apex
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="images/store-03.png" alt="Store Logo" class="img-fluid"> Grocery Bevy
                        </a>
                        <a href="javascript:void(0);" class="dropdown-item">
                            <img src="images/store-04.png" alt="Store Logo" class="img-fluid"> Grocery Eden
                        </a>
                    </div>
                </li>
                <!-- /Select Store -->
                ...
                <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);" role="button">
                        <img src="images/us.png" alt="Language" class="img-fluid">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right">
                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                        <span class="user-info">
                            <span class="user-letter">
                                <img src="images/avator1.jpg" alt="" class="img-fluid">
                            </span>
                            <span class="user-detail">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            ...
                            <hr class="m-0">
                            <a class="dropdown-item logout pb-0" href="signin.html"><img src="images/log-out.svg" class="me-2" alt="img">Logout</a>
                        </div>
                    </div>
                </li>
            </ul>
                            ...
                            <ul class="tabs owl-carousel pos-category">
                                <li id="all">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-01.png" alt="Categories">
                                    </a>
                                ...
                                <li id="headphones">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-02.png" alt="Categories">
                                    </a>
                                ...
                                <li id="shoes">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-03.png" alt="Categories">
                                    </a>
                                ...
                                <li id="mobiles">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-04.png" alt="Categories">
                                    </a>
                                ...
                                <li id="watches">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-05.png" alt="Categories">
                                    </a>
                                ...
                                <li id="laptops">
                                    <a href="javascript:void(0);">
                                        <img src="images/category-06.png" alt="Categories">
                                    </a>
                                    ...
                                    <div class="tab_content active" data-tab="all">
                                        <div class="row">
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-01.png" alt="Products">
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-02.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-03.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-04.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-05.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-06.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Shoes</a></h6>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-07.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-08.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Headphones</a></h6>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-09.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Watches</a></h6>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-10.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Computer</a></h6>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-11.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Watches</a></h6>
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-18.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Shoes</a></h6>
                                    ...
                                    <div class="tab_content" data-tab="mobiles">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-14.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Mobiles</a></h6>
                                    ...
                                    <div class="tab_content" data-tab="laptops">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3 pe-2">
                                                <div class="product-info default-cover card">
                                                    <a href="javascript:void(0);" class="img-bg">
                                                        <img src="images/pos-product-13.png" alt="Products">
                                                        <span><i data-feather="check" class="feather-16"></i></span>
                                                    </a>
                                                    <h6 class="cat-name"><a href="javascript:void(0);">Laptop</a></h6>
                                ...
                                <div class="row d-flex align-items-center justify-content-center methods">
                                    <div class="col-md-6 col-lg-4 item">
                                        <div class="default-cover">
                                            <a href="javascript:void(0);">
                                                <img src="images/cash-pay.svg" alt="Payment Method">
                                                <span>Cash</span>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4 item">
                                        <div class="default-cover">
                                            <a href="javascript:void(0);">
                                                <img src="images/credit-card.svg" alt="Payment Method">
                                    ...
                                    <div class="col-md-6 col-lg-4 item">
                                        <div class="default-cover">
                                            <a href="javascript:void(0);">
                                                <img src="images/qr-scan.svg" alt="Payment Method">
                                                <span>Scan</span>
                                            </a>
                                        </div>
                                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="icon-head text-center">
                        <a href="javascript:void(0);">
                            <img src="images/logo.png" width="100" height="30" alt="Receipt Logo">
                        </a>
                    </div>
                    <div class="text-center info text-center">
                        <h6>Dreamguys Technologies Pvt Ltd.,</h6>
                        <p class="mb-0">Phone Number: +1 5656665656</p>
                        <p class="mb-0">Email: <a href="/cdn-cgi/l/email-protection#2f4a574e425f434a6f48424e4643014c4042"><span class="__cf_email__" data-cfemail="badfc2dbd7cad6dffaddd7dbd3d694d9d5d7">[email�protected]</span></a></p>
                    </div>
                    ...
                    <div class="text-center invoice-bar">
                        ...
                        <a href="javascript:void(0);">
                            <img src="images/barcode-03.jpg" alt="Barcode">
                        </a>
                        <p>Sale 31</p>
                                ...
                                <div class="table-top">
                                    <div class="search-set">
                                        <div class="search-input">
                                            <a class="btn btn-searchset d-flex align-items-center h-100"><img src="images/search-white.svg" alt="img"></a>
                                        </div>
                                    </div>
                                    <div class="wordset">
                                        <ul>
                                            <li>
                                                <a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf"><img src="images/pdf.svg" alt="img"></a>
                                            </li>
                                            <li>
                                                <a class="d-flex align-items-center justify-content-center" data-bs-toggle="tooltip" data-bs-placement="top" title="Excel"><img src="images/excel.svg" alt="img"></a>
                                            </li>
                                            <li>
                            ...
                            <div class="tab-pane fade" id="return" role="tabpanel">
                                <div class="table-top">
                                    ...
                                    <div class="wordset">
                                        <ul>
                                            <li>
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Pdf" class="d-flex align-items-center justify-content-center"><img src="images/pdf.svg" alt="img"></a>
                                            </li>
                                            <li>
                                                <a data-bs-toggle="tooltip" data-bs-placement="top" title="Excel" class="d-flex align-items-center justify-content-center"><img src="images/excel.svg" alt="img"></a>
                                            </li>
                                            <li>
    ...
    <!-- jQuery -->
    <script data-cfasync="false" src="{{ asset('assets1/js/email-decode.min.js') }}"></script>
    
    <script src="{{ asset('assets1/js/jquery-3.7.1.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Feather Icon JS -->
    <script src="{{ asset('assets1/js/feather.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Slimscroll JS -->
    <script src="{{ asset('assets1/js/jquery.slimscroll.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Datatable JS -->
    <script src="{{ asset('assets1/js/jquery.dataTables.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <script src="{{ asset('assets1/js/dataTables.bootstrap5.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Bootstrap Core JS -->
    <script src="{{ asset('assets1/js/bootstrap.bundle.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Chart JS -->
    <script src="{{ asset('assets1/js/apexcharts.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <script src="{{ asset('assets1/js/chart-data.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Daterangepikcer JS -->
    <script src="{{ asset('assets1/js/moment.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <script src="{{ asset('assets1/js/daterangepicker.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Owl JS -->
    <script src="{{ asset('assets1/js/owl.carousel.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Select2 JS -->
    <script src="{{ asset('assets1/js/select2.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Sweetalert 2 -->
    <script src="{{ asset('assets1/js/sweetalert2.all.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>
    
    <script src="{{ asset('assets1/js/sweetalerts.min.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>

    <!-- Custom JS -->
    <script src="{{ asset('assets1/js/script.js') }}" type="b4db90db1a6e89f1c083e8cd-text/javascript"></script>


    <script src="{{ asset('assets1/js/rocket-loader.min.js') }}" data-cf-settings="b4db90db1a6e89f1c083e8cd-|49" defer=""></script>
</body>
