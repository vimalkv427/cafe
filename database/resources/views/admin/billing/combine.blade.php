...
<body class="pos-page">
    ...
    <script>
        let printType = ""; // Global variable to store the print type
        ...
        $(document).ready(function() {
            ...
            `;
                ...
                // Handle received and balance based on print type
                if (printType === "beforePayment") {
                    $("#receipt-received").text(`AED0.00`);
                    $("#receipt-balance").text(`AED0.00`);
                } else {
                    $("#receipt-received").text(`AED${receivedAmount.toFixed(2)}`);
                    $("#receipt-balance").text(`AED${balance.toFixed(2)}`);
                }
            ...
            // Print the receipt and handle logic based on print type
            window.printReceipt = function() {
                if (printType === "afterPayment") {
                    let orderIds = window.location.pathname.split("/").pop();
                    $.ajax({
                        url: `https://tictechnologies.in/live/karimeen.co.uk/billing/update-status/${orderIds}`,
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
                ...
                let receiptContent = document.getElementById("print-receipt").innerHTML;
               ...
               `);
                ...
                printWindow.focus();
                printWindow.print();
                printWindow.close(); // Prevent continuous print loop
