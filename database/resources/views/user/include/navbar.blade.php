            ...
            <div class="d-flex align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li>
                            <a href="{{ route('waiter.orders.index') }}" class="btn border add-btn shadow-none mx-2 d-none d-md-block">
                                <i class="billing mr-2"></i>Take Order
                            </a>
                        </li>

                        <!-- <li>
                            <a href="{{ route('product.add') }}" class="btn border add-btn shadow-none mx-2 d-none d-md-block"
